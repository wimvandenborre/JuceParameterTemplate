...
PolynatorAudioProcessor::PolynatorAudioProcessor()
{
    parameters.add(*this);
}

void PolynatorAudioProcessor::processBlock(juce::AudioBuffer<float>& buffer,
...
juce::AudioProcessorEditor* PolynatorAudioProcessor::createEditor()
{
    return new PolynatorAudioProcessorEditor(*this);
}

void PolynatorAudioProcessor::getStateInformation(juce::MemoryBlock& destData)
{
...
void PolynatorAudioProcessor::setStateInformation(const void* data,
                                                          int sizeInBytes)
{
...
{
    return new PolynatorAudioProcessor();
}
